...
class Square:
    ...
    def __eq__(self, other):
        """Returns True if the area of the square is
            equal to the area of the other square."""
        return self.area() == other.area()

    def __ne__(self, other):
        """Returns True if the area of the square is
            not equal to the area of the other square."""
        return self.area() != other.area()

    def __gt__(self, other):
        """Returns True if the area of the square is
            greater than the area of the other square."""
        return self.area() > other.area()

    def __ge__(self, other):
        """Returns True if the area of the square is
            greater than or equal to the area of the other square."""
        return self.area() >= other.area()

    def __lt__(self, other):
        """Returns True if the area of the square is
            less than the area of the other square."""
        return self.area() < other.area()
